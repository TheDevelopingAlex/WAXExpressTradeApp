...
public class OfferAdapter extends RecyclerView.Adapter<OfferAdapter.OfferViewHolder> {
    ...
    public static class OfferViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView yourOffer;
        public TextView theirOffer;
        public ImageButton mAcceptButton;
        public ImageButton mDeclineButton;
        public TextView mStatusTextStatus;
    ...
    public void onBindViewHolder(@NonNull OfferViewHolder offerViewHolder, final int position) {
        ...
        if (acceptVisibility)
            offerViewHolder.mAcceptButton.setVisibility(View.VISIBLE);
        else
            offerViewHolder.mAcceptButton.setVisibility(View.INVISIBLE);

        if (declineVisibility)
            offerViewHolder.mDeclineButton.setVisibility(View.VISIBLE);
        else
            offerViewHolder.mDeclineButton.setVisibility(View.INVISIBLE);
