                    ...
                    if (this.type.equals("sent")) {
                        ...
                        for (int i = 0; i < offers.length(); i++) {
                            try {
                                ...
                                mCallBack.onSuccess(new Offer(jsonObject.getInt("id"), sender.getString("display_name"),"Your Items ("+recipient_items_length+"): "+ String.format(java.util.Locale.US,"%.2f", recipient_items_price) +"$", "Their Items ("+sender_items_length+"): "+ String.format(java.util.Locale.US,"%.2f", sender_items_price)+ "$", sender.getString("avatar"), jsonObject.getString("state_name")));
